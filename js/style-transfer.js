...
async function stylize() {
  ...
  model.stylize(contentImg, styleImg).then((imageData) => {
	...
	var tmp_canvas = document.getElementById('stylized');
	var dataURL = tmp_canvas.toDataURL("image/png");
	$('#download-link').attr("href", dataURL.replace("image/png", "application/octet-stream"));
	// $('#thumbnail_list').append($('<a/>', { href : , download : "stylized.png" }).addClass('image').html("Download"));
  });
}
